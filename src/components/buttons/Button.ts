...
export class Button extends Phaser.GameObjects.Container {
	...
	bindInteractive(gameObject: Phaser.GameObjects.GameObject, draggable=false) {
	...
	onDragEnd(pointer: Phaser.Input.Pointer, dragX: number, dragY: number, dropped: boolean) {}
